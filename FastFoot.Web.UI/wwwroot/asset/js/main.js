!(function (e) {
  ...
  if (
    ...
    (l = ".ajax-reserve"),
      ...
      (d = '[name="email"]'),
      (u =
        '[name="name"],[name="email"],[name="number"],[name="date"],[name="time"],[name="guest"],[name="message"]'),
      (p = e(".form-messages"));
    function h() {
      var t = e(l).serialize();
      f() &&
    ...
    (e.fn.sectionSpace = function (t, a) {
      e(this).each(function () {
        ...
        (s = c.attr(t)),
          ...
          "margin-top" === s
            ? (e(n).css("padding-bottom", l + m(o) + "px"),
              c
                .css("margin-top", "-" + m(o) + "px")
                .css({ position: "relative", "z-index": "3" }))
            : "margin-bottom" === s &&
              (e(n).css("padding-top", r + m(i) + "px"),
              c
                .css("margin-bottom", "-" + m(i) + "px")
                .css({ position: "relative", "z-index": "3" }));
      });
    });
  e("[data-sec-space]").length &&
    ...
    e(".filter-active").imagesLoaded(function () {
      ...
      e('[data-bs-toggle="tab"]').on("shown.bs.tab", function (a) {
        e(t).isotope({ filter: "*" }),
          e(".filter-menu-active button:first-child")
            .addClass("active")
            .siblings()
            .removeClass("active");
      });
    ...
    e(".product-thumb-tab").length &&
      e(".product-thumb-tab").asTab({ sliderTab: !0, tabButton: ".tab-btn" }),
