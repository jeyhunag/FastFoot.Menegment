  ...
  var V = "collapse",
    ...
    ee = (function (e) {
      function o(t, i) {
        ...
        for (
          var o = Y.find('[data-bs-toggle="collapse"]'), s = 0, r = o.length;
          s < r;
          s++
        ) {
          var a = o[s],
      ...
      return (
        ...
        (s.hide = function () {
          ...
          if (
            !this._isTransitioning &&
            this._element.classList.contains("show") &&
            !W.trigger(this._element, "hide.bs.collapse").defaultPrevented
          ) {
  ...
  function je(e) {
    ...
    if (l) {
      ...
      v === ce(i) && (v = be(i)),
        ...
        o === oe &&
          ((p = ne), (c -= v.clientWidth - n.width), (c *= a ? 1 : -1));
    }
    var y,
        ...
        (("body" !== de(t) || Be(s)) &&
          (l =
            (n = t) !== ce(n) && fe(n)
              ...
              : Fe(n)),
        fe(t)
          ? (((d = We(t)).x += t.clientLeft), (d.y += t.clientTop))
          : s && (d.x = Re(s))),
      {
              ...
              if (it(t, i)) {
                ...
                for (var n = 0; n < a.orderedModifiers.length; n++)
                  if (!0 !== a.reset) {
                    ...
                    "function" == typeof s &&
                      (a =
                        s({ state: a, options: l, name: u, instance: c }) || a);
                  } else (a.reset = !1), (n = -1);
              }
            }
          },
      ...
      return (
        ...
        (s.show = function () {
          if (
            ...
            if (
              !W.trigger(this._element, "show.bs.dropdown", t).defaultPrevented
            ) {
              if (!this._inNavbar) {
                if (void 0 === at)
                  throw new TypeError(
        ...
        (s.hide = function () {
          if (
            ...
            var e = o.getParentFromElement(this._element),
              t = { relatedTarget: this._element };
            W.trigger(e, "hide.bs.dropdown", t).defaultPrevented ||
                ...
                if (
                  ...
                  !(
                    (e &&
                      ...
                      d.contains(e.target)) ||
                    W.trigger(s, "hide.bs.dropdown", a).defaultPrevented
                  )
                )
                  "ontouchstart" in document.documentElement &&
                    (l = []).concat
      ...
      return (
        ...
        (s.hide = function (e) {
          ...
          if (
            ...
            this._isShown &&
              !this._isTransitioning &&
              !W.trigger(this._element, "hide.bs.modal").defaultPrevented)
          ) {
            this._isShown = !1;
        ...
        (s._showElement = function (e) {
          ...
          var o = function () {
            t._config.focus && t._element.focus(),
              ...
              W.trigger(t._element, "shown.bs.modal", { relatedTarget: e });
          };
          if (i) {
        ...
        (s._triggerBackdropTransition = function () {
          var e = this;
          if (
            !W.trigger(this._element, "hidePrevented.bs.modal").defaultPrevented
          ) {
            var t =
        ...
        (s._resetScrollbar = function () {
          Y.find(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top").forEach(
            function (e) {
              ...
              void 0 !== t &&
                (N.removeDataAttribute(e, "padding-right"),
            ...
            Y.find(".sticky-top").forEach(function (e) {
              ...
              void 0 !== t &&
                (N.removeDataAttribute(e, "margin-right"),
                (e.style.marginRight = t));
            });
          var e = N.getDataAttribute(document.body, "padding-right");
          void 0 === e
            ? (document.body.style.paddingRight = "")
            : (N.removeDataAttribute(document.body, "padding-right"),
    ...
    Ht = (function (e) {
      ...
      return (
        ...
        (s._getConfig = function (e) {
          if (
            "string" !=
              typeof (e = i({}, qt, "object" == typeof e && e ? e : {}))
                .target &&
            f(e.target)
          ) {
            var t = e.target.id;
    ...
    return (
      (o.show = function () {
        ...
        if (
          ...
          if (
            (t &&
              (s = W.trigger(t, "hide.bs.tab", {
                relatedTarget: this._element,
              })),
            !(
              W.trigger(this._element, "show.bs.tab", { relatedTarget: t })
                .defaultPrevented ||
            ...
            var r = function () {
              W.trigger(t, "hidden.bs.tab", { relatedTarget: e._element }),
                W.trigger(e._element, "shown.bs.tab", { relatedTarget: t });
            };
    ...
    Ut = (function (e) {
      ...
      return (
        ...
        (s.hide = function () {
          ...
          if (
            this._element.classList.contains("show") &&
            !W.trigger(this._element, "hide.bs.toast").defaultPrevented
          ) {
            var t = function () {
      ...
      (t.prototype.handleScroll = function () {
        ...
        for (var i in t) {
          ...
          for (var s in this.waypoints[i]) {
            ...
            ((a && l) || (!a && !l)) &&
              (r.queueTrigger(o), (e[r.group.id] = r.group));
          }
        }
        ...
        (e = {
          ...
          for (var a in this.waypoints[s]) {
            ...
            f.element !== f.element.window &&
              (m = f.adapter.offset()[r.offsetProp]),
              "function" == typeof h
                ? (h = h.apply(f))
                : "string" == typeof h &&
                  ((h = parseFloat(h)),
              ...
              !g && d && c
                ...
                : ((!g && u) || (g && r.oldScroll >= f.triggerPoint)) &&
    ...
    (e = function (e, t) {
      ...
      ((DateFormatter = function (e) {
        ...
        parseDate: function (t, i) {
          ...
          for (
            o = t.replace(h.separators, "\0").split("\0"), s = 0;
            s < o.length;
            s++
          )
        ...
        guessDate: function (e, t) {
          ...
          for (o = 0; o < l.length; o++) {
            if (((u = 2), (r = l[o]), (a = parseInt(r.substr(0, 2))), isNaN(a)))
              return null;
            switch (o) {
              case 0:
      ...
      return (
        (r = function (t) {
          ...
          var q = function (e) {
            ...
            Math.sqrt(n * n + o * o) > S.touchMovedThreshold &&
              (this.touchMoved = !0);
          };
          function $() {
            var e,
          ...
          A.find(".xdsoft_select")
              ...
              if (!this.touchMoved) {
                ...
                C &&
                  ...
                  S.onChangeMonth &&
                    ...
                    S.onChangeMonth.call(D, C.currentTime, D.data("input")),
                  t !== C.currentTime.getFullYear() &&
                    e.isFunction(S.onChangeYear) &&
                    S.onChangeYear.call(D, C.currentTime, D.data("input"));
              }
            }),
            (D.getValue = function () {
            ...
            (D.setOptions = function (n) {
              ...
              (S = e.extend(!0, {}, S, n)),
                ...
                S.inline &&
                  ((R = !0), D.addClass("xdsoft_inline"), t.after(D).hide()),
                S.inverseButton &&
                ...
                S.validateOnBlur &&
                  t.off("blur.xdsoft").on("blur.xdsoft", function () {
                    if (
                      ...
                      e(this).val(null), D.data("xdsoft_datetime").empty();
                    else {
              ...
              (t.now = function (e) {
                ...
                (t.strToDateTime = function (e) {
                  ...
                  return e && e instanceof Date && t.isValidDate(e)
                    ? e
                    : ((s = /^([+-]{1})(.*)$/.exec(e)) &&
                        (s[2] = i.parseDate(s[2], S.formatDate)),
                      (o =
                        s && s[2]
                          ? ((n =
              ...
              function () {
                ...
                !(function e(s) {
                  ...
                  t.hasClass(S.next) && a - r - S.timeHeightInTimePicker >= l
                    ...
                    z.trigger("scroll_element.xdsoft_scroller", [
                      Math.abs(parseInt(I[0].style.marginTop, 10) / (a - r)),
                    ]),
                    (o = 10 < o ? 10 : o - 10),
            ...
            D.on("xchange.xdsoft", function (r) {
              clearTimeout(s),
                (s = setTimeout(function () {
                  ...
                  for (
                    ...
                    m +=
                      "<th>" +
                      S.i18n[o].dayOfWeekShort[(s + S.dayOfWeekStart) % 7] +
                      "</th>";
                  for (
                    m += "</tr></thead>",
                      m += "<tbody>",
                    ...
                    ((!1 !== b && b < g) ||
                      ...
                      (S.defaultSelect || D.data("changed")) &&
                        i.formatDate(C.currentTime, S.formatDate) ===
                          i.formatDate(g, S.formatDate) &&
                        k.push("xdsoft_current"),
                      i.formatDate(y, S.formatDate) ===
                        i.formatDate(g, S.formatDate) && k.push("xdsoft_today"),
                      (0 !== g.getDay() &&
                        6 !== g.getDay() &&
                        -1 ===
                  ...
                  (m += "</tbody></table>"),
                    ...
                    A.find(".xdsoft_label span")
                      .eq(0)
                      .text(S.i18n[o].months[C.currentTime.getMonth()]),
                    A.find(".xdsoft_label span")
                      .eq(1)
                  ...
                  if (
                    (!1 !== S.maxDateTime &&
                      ...
                      i.formatDate(C.currentTime, S.formatDate) ===
                        i.formatDate(M, S.formatDate) &&
                        (L = 60 * M.getHours() + M.getMinutes()) < z &&
                        (z = L)),
                    (f = function (n, o) {
                      var s,
                        r = C.now(),
                      ...
                      (t.is("[disabled]") || z <= l || l < P) &&
                        ...
                        (S.initTime || S.defaultSelect || D.data("changed")) &&
                          ...
                          (S.defaultSelect || D.data("changed")
                            ? k.push("xdsoft_current")
                            : S.initTime && k.push("xdsoft_init_time")),
                  ...
                  for (
                    I.html(O), n = "", v = parseInt(S.yearStart, 10);
              ...
              var e, t, i, n;
              S.timepicker &&
                (I.find(".xdsoft_current").length
                  ? (e = ".xdsoft_current")
                  : I.find(".xdsoft_init_time").length &&
                    (e = ".xdsoft_init_time"),
                e
                  ? ((t = z[0].clientHeight),
                    (i = I[0].offsetHeight) - t <
                      (n = I.find(e).index() * S.timeHeightInTimePicker + 1) &&
                      (n = i - t),
                    z.trigger("scroll_element.xdsoft_scroller", [
                      parseInt(n, 10) / (i - t),
                    ]))
            ...
            E.on("touchend click.xdsoft", "td", function (i) {
              ...
              o.setDate(1),
                ...
                S.onSelectDate &&
                  ...
                  S.onSelectDate.call(D, C.currentTime, D.data("input"), i),
                D.data("changed", !0),
                D.trigger("xchange.xdsoft"),
                D.trigger("changedatetime.xdsoft"),
                (1 < r ||
                ...
                if (!this.touchMoved) {
                  ...
                  n.setHours(i.data("hour")),
                    ...
                    S.onSelectTime &&
                      ...
                      S.onSelectTime.call(D, C.currentTime, D.data("input"), t),
                    D.data("changed", !0),
                    D.trigger("xchange.xdsoft"),
                    D.trigger("changedatetime.xdsoft"),
                    !0 !== S.inline &&
            ...
            t.on("mousewheel.xdsoft", function (e) {
              return (
                ...
                (!S.datepicker && S.timepicker
                  ? (0 <=
                      (a = I.find(".xdsoft_current").length
                        ? I.find(".xdsoft_current").eq(0).index()
                        : 0) +
                        e.deltaY &&
                      a + e.deltaY < I.children().length &&
                      (a += e.deltaY),
                    I.children().eq(a).length &&
                      I.children().eq(a).trigger("mousedown"),
                    !1)
                  : S.datepicker && !S.timepicker
                  ? (P.trigger(e, [e.deltaY, e.deltaX, e.deltaY]),
                    t.val && t.val(C.str()),
                    D.trigger("changedatetime.xdsoft"),
                    !1)
                  : void 0)
            ...
            D.on("changedatetime.xdsoft", function (t) {
              ...
              .on("generate.xdsoft", function () {
                S.onGenerate &&
                  ...
                  S.onGenerate.call(D, C.currentTime, D.data("input")),
                  R && (D.trigger("afterOpen.xdsoft"), (R = !1));
              })
                ...
                S.fixed
                  ...
                  : ((a = !1),
                    ...
                    a && !S.insideParent
                      ? ((s = "fixed"),
                        n + D.outerHeight() > f + h
                          ? ((c = "bottom"), (n = f + h - t.top))
                          : (n -= h))
                      : n + D[0].offsetHeight > f + h &&
                        (n = t.top - D[0].offsetHeight + 1),
                    n < 0 && (n = 0),
            ...
            D.on("open.xdsoft", function (t) {
              ...
              S.onShow &&
                ...
                (i = S.onShow.call(D, C.currentTime, D.data("input"), t)),
                !1 !== i &&
                  (D.show(),
                  l(),
                  e(S.contentWindow)
              ...
              .on("close.xdsoft", function (t) {
                ...
                A.find(".xdsoft_month,.xdsoft_year")
                  ...
                  S.onClose &&
                    ...
                    (i = S.onClose.call(D, C.currentTime, D.data("input"), t)),
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  function h(e, t, i, n, a) {
      ...
      (d = (h = e[k]).a),
        ...
        (g = a
          ? ((b = o[l]),
            ...
            c -
              ((p = c - (c - d) * (n ? 0.5 * t : 0 !== b ? w / b : 0)) +
                ((((m = c + (u - c) * (n ? 0.5 * t : 0 !== _ ? w / _ : 0)) -
                  p) *
                  ((3 * b) / (b + _) + 0.5)) /
                  4 || 0)))
          : c -
            ((p = c - (c - d) * t * 0.5) + (m = c + (u - c) * t * 0.5)) / 2),
        (p += g),
        (m += g),
        (h.c = v = p),
    ...
    ((h = e[k]).b = T),
      ...
      (h.ca = h.c - h.a),
      (h.ba = T - h.a),
      i && ((y = f(h.a, T, h.c, h.d)), e.splice(k, 1, y[0], y[1], y[2], y[3]));
  }
  function p(e, t, i, n) {
    var r,
      a,
    ...
    if (n)
      for (a = (e = [n].concat(e)).length; -1 < --a; )
        "string" == typeof (f = e[a][t]) &&
          "=" === f.charAt(1) &&
          (e[a][t] = n[t] + Number(f.charAt(0) + f.substr(2)));
    if ((r = e.length - 2) < 0)
  ...
  function m(e, t, i, n, l, d) {
    ...
    for (o.length = s.length = r.length = 0, c = w.length; -1 < --c; )
      (u = w[c]),
        (a[u] = -1 !== l.indexOf("," + u + ",")),
        (_[u] = p(e, u, a[u], d));
    for (c = o.length; -1 < --c; )
  ...
  function g(e, t, i) {
    for (
      var n, o, s, r, a, l, d, c, u, f, h, p = 1 / i, m = e.length;
      -1 < --m;
  ...
  _gsScope._gsDefine(
    ...
    function (e, t, i) {
          ...
          if (o._initted || r)
            if (t) (o._initted = !1), r && o.render(0, !0, !0);
              ...
              for (var l, d = 1 / (1 - s), c = o._firstPT; c; )
                (l = c.s + c.c), (c.c *= d), (c.s = l - c.c), (c = c._next);
          return o;
        }),
      ...
      function m(e, i, n, o) {
        (i = !1 !== i), (n = !1 !== n);
        for (
          var s, r, a = p((o = !1 !== o)), l = i && n && o, d = a.length;
          -1 < --d;
        ...
        return (
          ...
          (v.staggerTo = function (e, t, r, l, d, c, f, h) {
            ...
            for (
              ...
              (p = o(r)),
                y && ((p.startAt = o(y)), y.cycle && s(p.startAt, e, m)),
                b &&
                  (s(p, e, m),
          ...
          (v.staggerFromTo = function (e, t, i, n, o, s, a, l, d) {
            return (
              (n.startAt = i), this.staggerTo(e, t, r(0, n, i), o, s, a, l, d)
            );
          }),
          ...
          (v.add = function (o, s, r, a) {
            ...
            if (
              ...
              if (o instanceof Array || (o && o.push && f(o))) {
                for (
                  r = r || "normal", a = a || 0, l = s, d = o.length, c = 0;
                  c < d;
                  c++
                )
          ...
          (v.render = function (e, t, i) {
              ...
              if (m < e)
                for (n = f._first; n && n._startTime <= e && !d; )
                  n._duration ||
                    "isPause" !== n.data ||
                    n.ratio ||
                    (0 === n._startTime && 0 === f._rawPrevTime) ||
                    (d = n),
                    (n = n._next);
              else
                for (n = f._last; n && n._startTime >= e && !d; )
                  n._duration ||
                    ("isPause" === n.data && 0 < n._rawPrevTime && (d = n)),
                    (n = n._prev);
              d &&
                ((f._time = f._totalTime = e = d._startTime),
                (u =
                  f._startTime +
                  (f._reversed ? f._duration - e : e) / f._timeScale));
            }
            if (g - l <= e && 0 <= e)
              (f._totalTime = f._time = g),
                ...
                (f._rawPrevTime =
                  f._duration || !t || e || f._rawPrevTime === e ? e : l),
                (e = g + 1e-4);
            else if (e < l)
              if (
                ...
                (0 !== m ||
                  (0 === f._duration &&
                    f._rawPrevTime !== l &&
                    (0 < f._rawPrevTime || (e < 0 && 0 <= f._rawPrevTime)))) &&
                  ((r = "onReverseComplete"), (o = f._reversed)),
                e < 0)
              )
                (f._active = !1),
            ...
            if ((f._time !== m && f._first) || i || a || d) {
              if (
                ...
                f._active ||
                  (!f._paused && f._time !== m && 0 < e && (f._active = !0)),
                0 === m &&
                  f.vars.onStart &&
                ...
                for (
                  n = f._first;
                  n && ((s = n._next), c === f._time && (!f._paused || b));
                ...
                for (
                  n = f._last;
                  n && ((s = n._prev), c === f._time && (!f._paused || b));
              ...
              if (
                ...
                (0 !== g ||
                  (0 === y &&
                    ...
                    (0 < x || (e < 0 && 0 <= x)) &&
                    !m._locked)) &&
                  ((d = "onReverseComplete"), (s = m._reversed)),
                e < 0)
              )
                (m._active = !1),
                  m._timeline.autoRemoveChildren && m._reversed
                    ? ((c = s = !0), (d = "onReverseComplete"))
                    : 0 <= x && m._first && (c = !0),
                  (m._rawPrevTime = e);
              else {
                if (
            ...
            if (m._hasPause && !m._forcingPlayhead && !t) {
              if (g < (e = m._time) || (m._repeat && T !== m._cycle))
                ...
                for (n = m._last; n && n._startTime >= e && !f; )
                  n._duration ||
                    ("isPause" === n.data && 0 < n._rawPrevTime && (f = n)),
                    (n = n._prev);
              f &&
                ((p =
                  m._startTime +
      ...
      set: function (e) {
        ...
        if (this._timeRes) {
          ...
          a =
            1 === e
              ? 1
              : (o + (f - this._s1) / (this._s2 - this._s1)) * this._prec || 0;
        } else
          a =
      ...
      function (e, t) {
        ...
        function g(e, t) {
          ...
          if ((t = t || m(e)))
            if ((i = t.length))
              for (; -1 < --i; )
                (-1 !== (o = t[i]).indexOf("-transform") && Be !== o) ||
        ...
        var T,
          ...
          ae =
            ...
            (C =
              -1 !== re.indexOf("Safari") &&
              -1 === re.indexOf("Chrome") &&
              (-1 === E || 3 < parseFloat(re.substr(E + 8, 2)))),
            ...
            !!M &&
              ((M.style.cssText = "top:1px;opacity:.55;"),
            ...
            return ae || "opacity" !== t
              ? (!n && e.style[t]
                  ...
                  ? (s =
                      ...
                      i.getPropertyValue(t.replace(N, "-$1").toLowerCase()))
          ...
          he = (se.calculateOffset = function (e, t, i) {
            ...
            var n = "left" === t ? "Left" : "Top",
              o = ue(e, "margin" + n, i);
            return (
              e["offset" + n] - (fe(e, t, parseFloat(o), o.replace(R, "")) || 0)
            );
          }),
        ...
        var ke =
          ...
          Se = (r.parseComplex = function (e, t, i, n, o, s, a, l, d, c) {
            ...
            for (
              (-1 === n.indexOf(",") && -1 === i.indexOf(",")) ||
                ((O =
                  -1 !== (n + i).indexOf("rgb") || -1 !== (n + i).indexOf("hsl")
                    ? ((C = C.join(" ").replace(J, ", ").split(" ")),
                      O.join(" ").replace(J, ", ").split(" "))
              ...
              if (((p = C[u]), (m = O[u] + ""), (y = parseFloat(p)) || 0 === y))
                a.appendXtra(
                  "",
                  y,
                  b(m, y),
                  m.replace(I, ""),
                  j && -1 !== m.indexOf("px") && Math.round,
                  !0
                );
              else if (o && be.test(p))
                (k = ")" + ((k = m.indexOf(")") + 1) ? m.substr(k) : "")),
                  ...
                  (_ = 6 < p.length + m.length) && !ae && 0 === m[3]
                    ? ((a["xs" + a.l] += a.l ? " transparent" : "transparent"),
                      (a.e = a.e.split(O[u]).join("transparent")))
                    : (ae || (_ = !1),
                      S
                        ? a
                            .appendXtra(
                ...
                for (f = h = 0; f < g.length; f++)
                  (x = g[f]),
                    ...
                    a.appendXtra(
                      ...
                      b(v[f], x),
                      "",
                      j && "px" === p.substr(w + x.length, 2) && Math.round,
                      0 === f
                    ),
                    (h = w + x.length);
                a["xs" + a.l] += p.substr(h);
            ...
            if (!l[e]) {
              ...
              De(e, {
                parser: function (e, i, n, o, s, r, d) {
                  ...
                  return c
                    ? (c._cssRegister(), l[n].parse(e, i, n, o, s, r, d))
            ...
            if (
              (null != n.ox &&
                ((b +=
                  ...
                  (h * a + (p = (n.oyp ? g * n.oy * 0.01 : n.oy) - g / 2) * l)),
                (_ += p - (h * d + p * c))),
              (y += v
                ? ", Dx=" +
                  ((h = m / 2) - (h * a + (p = g / 2) * l) + b) +
              ...
              for (
                ...
                (k =
                  (i =
                    -1 !== (w = f[(x = me[Ce])]).indexOf("px")
                      ? parseFloat(w)
                      : fe(this.t, x, parseFloat(w), w.replace(R, "")) || 0) !==
                  n[x]
                    ? Ce < 2
                      ? -n.ieOffsetX
                      : -n.ieOffsetY
        ...
        var Me,
            ...
            if (
              ...
              Re &&
                ...
                ((l = e.parentNode) && e.offsetParent) ||
                  ((r = 1), (a = e.nextSibling), Ye.appendChild(e)),
                (i =
                  !(n = ue(e, Be, null, !0)) ||
                  "none" === n ||
              ...
              return Qe;
            for (o = (n || "").match(z) || [], Ce = o.length; -1 < --Ce; )
              (s = Number(o[Ce])),
                (o[Ce] = (r = s - (s |= 0))
          ...
          Ve = (se.getTransform = function (e, i, n, o) {
            ...
            var s,
              ...
              p =
                ($e &&
                  (parseFloat(ue(e, qe, i, !1, "0 0 0").split(" ")[2]) ||
                    f.zOrigin)) ||
                0,
            ...
            if (
              ...
              if (16 === s.length) {
                ...
                f.zOrigin &&
                  ...
                  (f.rotationY = L * Z),
                  L &&
                    ((v = x * (b = Math.cos(-L)) - P * (_ = Math.sin(-L))),
                    (y = k * b - A * _),
                    (P = x * _ + P * b),
                    (A = k * _ + A * b),
                    (I = T * _ + I * b),
                  ...
                  (f.rotation = L * Z),
                  L &&
                    ((g = w * (b = Math.cos(L)) + x * (_ = Math.sin(L))),
                    (v = S * b + C * _),
                    (y = j * b + P * _),
                    (x = x * b - w * _),
                    (C = C * b - S * _),
                  ...
                  (f.scaleY =
                    ((1e5 * Math.sqrt(C * C + O * O) + 0.5) | 0) / 1e5),
                  (f.scaleZ =
                    ((1e5 * Math.sqrt(j * j + P * P + A * A) + 0.5) | 0) / 1e5),
                  (w /= f.scaleX),
                  (S /= f.scaleY),
                  (x /= f.scaleX),
                  (C /= f.scaleY),
                ...
                (f.x = s[4] || 0),
                  ...
                  $e &&
                    ...
                    (f.scaleZ = 1)),
                  f.svg &&
                    ((f.x -= f.xOrigin - (f.xOrigin * F + f.yOrigin * B)),
                    ...
                    ? ((C *= K),
                      ...
                      L &&
                        ...
                        Me &&
                          ...
                          ((m = this.t.getBBox()),
                          (M += 0.01 * T.xPercent * m.width),
                          (z += 0.01 * T.yPercent * m.height)),
                        M < (m = 1e-6) && -m < M && (M = 0),
                        z < m && -m < z && (z = 0)),
                      (b =
                        ((i * k) | 0) / k +
        ...
        ((d = He.prototype).x =
            ...
            "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin",
            {
              parser: function (e, t, i, n, s, a, l) {
                ...
                var c,
                  ...
                  D =
                    ...
                    ("function" == typeof T.transform
                      ...
                      : T.transform);
                if (
                  ((O.skewType = T.skewType || O.skewType || r.defaultSkewType),
                  (n._transform = O),
                  ...
                  ((u = ne.style)[Re] = D),
                    ...
                    null != T.xPercent &&
                      (c.xPercent = _(T.xPercent, O.xPercent)),
                    null != T.yPercent &&
                      (c.yPercent = _(T.yPercent, O.yPercent));
                  ...
                  "string" == typeof T.x &&
                    -1 !== T.x.indexOf("%") &&
                    ((c.x = 0), (c.xPercent = _(T.x, O.xPercent))),
                    "string" == typeof T.y &&
                      -1 !== T.y.indexOf("%") &&
                      ((c.y = 0), (c.yPercent = _(T.y, O.yPercent))),
                    (c.rotation = w(
                      "rotation" in T
                        ? T.rotation
                        : "shortRotation" in T
                ...
                return (
                      ...
                      ? ((h = !0),
                        ...
                        $e
                          ? ((u = O.zOrigin),
                            (D = D.split(" ")),
                            (O.zOrigin =
                              (2 < D.length ? parseFloat(D[2]) : u) || 0),
                            (s.xs0 = s.e =
                              D[0] + " " + (D[1] || "50%") + " 0px"),
                            ((s = new Te(O, "zOrigin", 0, 0, s, -1, s.n)).b =
                              u),
                            (s.xs0 = s.e = O.zOrigin))
                          : (s.xs0 = s.e = D))
                      : ge(D + "", O)),
                  h &&
                    (n._transformType =
                      (O.svg && Me) || (!f && 3 !== this._transformType)
                        ? 2
                        : 3),
                  d && (l.scale = d),
                  s
            ...
            parser: function (e, t, i, s, r, a) {
              ...
              for (
                ...
                this.p.indexOf("border") && (S[d] = p(S[d])),
                  -1 !== (f = u = ue(e, S[d], o, !1, "0px")).indexOf(" ") &&
                    ((f = (u = f.split(" "))[0]), (u = u[1])),
                  (h = c = l[d]),
                  (m = parseFloat(f)),
                  (_ = f.substr((m + "").length)),
          ...
          De("backgroundPosition", {
            ...
            parser: function (e, t, i, n, s, r) {
              ...
              if (
                ...
                v.split(",").length < 2 &&
                (f = ue(e, "backgroundImage").replace(G, "")) &&
                "none" !== f
              ) {
                for (
                  a = g.split(" "),
          ...
          De("border", {
            ...
            parser: function (e, t, i, n, s, r) {
              ...
              return (
                "px" !== d &&
                  (a = parseFloat(a) / fe(e, "borderTopWidth", 1, d) + d),
                this.parseComplex(
                  e.style,
                  this.format(
                    a +
              ...
              if (
                ...
                (u = ue(e, r, o) + ""),
                  ...
                  (v && H.test(f))
                    ? (v ||
                        (f =
                          (3 < (f = ye(f)).length ? "rgba(" : "rgb(") +
                          f.join(",") +
                          ")"),
                      (i = Se(_, r, u, f, !0, "transparent", i, 0, s)))
                    : v && V.test(f)
  ...
  (function (e, t) {
      ...
      y =
        ...
        function (e) {
          return (
            null != e &&
            (e instanceof Array ||
              ("object" == typeof e && !!e.push && p.call(e) === m))
          );
        }),
      b = {},
      _ = function (n, s, a, l) {
    ...
    x("Ticker", function (e, t) {
      ...
      O.call(d),
        ...
        (d.lagSmoothing = function (e, t) {
          return arguments.length
            ? ((p = e || 1e8), void (m = Math.min(t, p, 0)))
            : p < 1e8;
        }),
        (d.sleep = function () {
          null != s &&
            ((u && j ? j : clearTimeout)(s),
            (o = l),
            (s = null),
            d === f && (h = !1));
        }),
        ...
        (d.fps = function (e) {
          return arguments.length
            ? ((r = 1 / ((i = e) || 60)), (a = this.time + r), void d.wake())
            : i;
        }),
        (d.useRAF = function (e) {
    ...
    var M = function () {
      h &&
        2e3 < P() - A &&
        ("hidden" !== (n || {}).visibilityState || !f.lagSmoothing()) &&
        f.wake();
        ...
        if (this._timeline) {
          ...
          this._gc && this._enabled(!0, !1),
            (this._totalTime === e && 0 !== this._duration) ||
              (q.length && ee(), this.render(e, t, !1), q.length && ee());
        }
        return this;
      }),
    ...
    var L = x(
      "TweenLite",
      function (t, i, n) {
        if ((E.call(this, i, n), (this.render = L.prototype.render), null == t))
          ...
          for (
            ...
            (s = r[o])
              ? "string" != typeof s
                ...
                : "string" == typeof (s = r[o--] = L.selector(s)) &&
                  r.splice(o + 1, 1)
              : r.splice(o--, 1);
        else
          (this._propLookup = {}),
          ...
          (a = o[s]) === t ||
            ...
            (a._timeline !== t._timeline
              ...
              : a._startTime <= c &&
                ...
                (((h || !a._initted) && c - a._startTime <= 2e-8) ||
                  (u[f++] = a)));
        for (s = f; -1 < --s; )
          if (
            ((l = (a = u[s])._firstPT),
      ...
      (u._initProps = function (t, i, n, o, s) {
        ...
        this.vars))
          if (((u = this.vars[r]), Q[r]))
            ...
            G[r] &&
            (d = new G[r]())._onInitTween(t, this.vars[r], this, s)
          ) {
            for (
              this._firstPT = c =
                {
      ...
      (u.render = function (e, t, i) {
        ...
        if (d - v <= e && 0 <= e)
          ...
          (1 === f || (3 === f && 0.5 <= u)) && (u = 1 - u),
            ...
            1 === h
              ...
              : 4 === h && (u *= u * u * u * u),
            (a.ratio =
              1 === f ? 1 - u : 2 === f ? u : e / d < 0.5 ? u / 2 : 1 - u / 2);
        ...
        if (a._time !== l || i) {
          if (!a._initted) {
            ...
            a._time && !n
              ? (a.ratio = a._ease.getRatio(a._time / d))
              : n &&
                a._ease._calcEnd &&
            ...
            this.revert(),
              ...
              r(this.elements, function (e) {
                for (var t = l(e).nodes || [], i = 0, n = t.length; i < n; i++)
                  (s = (o = t[i]) && o[u]) && (delete o[s], delete f[s]);
                var o, s;
              });
          }),
